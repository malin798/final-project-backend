...
app.put('/users/:userId/watchlist', async (req, res) => {
  try {
    ...
    const { title, showId, poster, overview, year, country } = req.body
    ...
    const showItem = { "title": title, "showId": showId, "poster": poster, "overview": overview, "year": year, "country": country }
